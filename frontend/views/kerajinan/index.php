...
$this->title = 'Informasi Oleh-oleh Kota Pariaman';
?>
    ...
    <div class="row">
        <main id="main" class="col-md-9">
            <div style="background-color: #800000;height: 50px;margin-top: 0px; margin-bottom: 15px;">
                <a href="#">
                <h3 style="padding: 10px; color: #FFF"> <i class="fa fa-building"></i> Oleh-oleh</h3>
                </a>
            </div>

            <div class="blog-inner area-padding">
                <div class="row">
                    <?php foreach ($allKerajinan as $k) { ?>
                        ...
                        <div class="single-blog">
                          <div class="single-blog-img" style="padding-bottom: 10px;">
                            <a href="blog.html" style="text-align: center;">
                                <!-- <img class="img-responsive" style="width: 300px; height: 150px"src="<?php //echo Url::to('@web/login/images/kuliner/'. $k->agenda_photoid)?>" alt=""> -->
                            </a>
                          </div>
                          <div class="blog-text">
                            <div style="height: 35px;overflow: hidden;">
                            <h4 style="font-size: 16px;">
                                <a href="blog.html"><?= StringHelper::truncateWords(strip_tags($k->kerajinan_usaha), 10)?></a>
                            </h4>
                            </div>
                            <div style="height: 70px;overflow: hidden;">
                            <p style="font-size: 14px; text-align: justify; color: #354052">
                              <?= StringHelper::truncateWords(strip_tags($k->kerajinan_keterangan), 20)?>
                            </p>
                            </div>
                          </div>
                          <span>
                             <a style="padding: 5px;" href="<?= Url::to(['/kerajinan/baca']) ?>?id=<?= $k->kerajinan_id?>" class="outline-btn">Selengkapnya <i class="fa fa-fw fa-arrow-circle-right"></i></a>
                          </span>
                        </div>
                      </div>
                     <?php } ?>
              ...
              <aside id="aside" class="col-md-3">
                <div class="widget">
                    <a href="<?= Url::to(['/kerajinan/']) ?>"><h3 class="title">Kerajinan Lainnya</h3></a>
                    <div class="widget-category">
                        <?php foreach ($listKerajinan as $k) { ?>
