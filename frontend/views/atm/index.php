...
$this->title = 'Informasi ATM di Kota Pariaman';
?>
    ...
    <div class="row">
        <main id="main" class="col-md-9">
            <div style="background-color: #800000;height: 50px;margin-top: 0px; margin-bottom: 15px;">
                <a href="#">
                <h3 style="padding: 10px; color: #FFF"> <i class="fa fa-building"></i> ATM</h3>
                </a>
            </div>

            <div class="blog-inner area-padding">
                <div class="row">
                    <?php foreach ($allAtm as $a) { ?>
                        ...
                        <div class="single-blog">
                          ...
                          <div class="blog-text">
                            ...
                            <h4 style="font-size: 16px;">
                                <a href="blog.html"><?= StringHelper::truncateWords(strip_tags($a->atm_nama), 10)?></a>
                            </h4>
                            </div>
                            <div style="height: 70px;overflow: hidden;">
                            <p style="font-size: 14px; text-align: justify; color: #354052">
                              <?= StringHelper::truncateWords(strip_tags($a->atm_alamat), 20)?>
                            </p>
                            </div>
                          </div>
                          <span>
                             <a style="padding: 5px;" href="<?= Url::to(['/atm/baca']) ?>?id=<?= $a->atm_id?>" class="outline-btn">Selengkapnya <i class="fa fa-fw fa-arrow-circle-right"></i></a>
                          </span>
                        </div>
                      </div>
                     <?php } ?>
              ...
              <aside id="aside" class="col-md-3">
                <div class="widget">
                    <a href="<?= Url::to(['/atm/']) ?>"><h3 class="title">Atm Lainnya</h3></a>
                    <div class="widget-category">
                        <?php foreach ($listAtm as $a) { ?>
