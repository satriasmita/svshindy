...
$this->title = 'Informasi SPBU di Kota Pariaman';
?>
<div class="header-wrapper sm-padding bg-grey" style="padding: 25px;">
    <div class="container" style="width: 80%">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= Url::to(['/spbu/']) ?>">SPBU</a></li>
        </ul>
    </div>
</div>
    ...
    <div class="row">
        <main id="main" class="col-md-9">
            <div style="background-color: #800000;height: 50px;margin-top: 0px; margin-bottom: 15px;">
                <a href="#">
                <h3 style="padding: 10px; color: #FFF"> <i class="fa fa-building"></i> SPBU</h3>
                </a>
            </div>

            <div class="blog-inner area-padding">
                <div class="row">
                    <?php foreach ($allSpbu as $s) { ?>
                        ...
                        <div class="single-blog">
                          ...
                          <div class="blog-text">
                            ...
                            <h4 style="font-size: 16px;">
                                <a href="blog.html"><?= StringHelper::truncateWords(strip_tags($s->spbu_nama), 10)?></a>
                            </h4>
                            </div>
                            <div style="height: 70px;overflow: hidden;">
                            <p style="font-size: 14px; text-align: justify; color: #354052">
                              <?= StringHelper::truncateWords(strip_tags($s->spbu_alamat), 20)?>
                            </p>
                            </div>
                          </div>
                        </div>
