...
class HotelSearch extends Hotel
{
    ...
    public function rules()
    {
        return [
            [['hotel_id'], 'integer'],
            [['h_nama', 'h_alamat', 'h_telp', 'foto', 'foto2', 'foto3', 'foto4', 'h_longitude', 'h_latitude'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'h_nama', $this->h_nama])
            ...
            ->andFilterWhere(['like', 'h_latitude', $this->h_longitude])
            ->andFilterWhere(['like', 'h_longitude', $this->h_latitude]);
