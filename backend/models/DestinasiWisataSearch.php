...
/**
 * DestinasiWisataSearch represents the model behind the search form of `backend\models\DestinasiWisata`.
 */
class DestinasiWisataSearch extends DestinasiWisata
{
    ...
    public function rules()
    {
        return [
            ...
            [['nama_destinasi', 'detail','alamat', 'longitude', 'latitude', 'foto', 'foto2', 'foto3', 'foto4'], 'safe'],
        ];
    }
